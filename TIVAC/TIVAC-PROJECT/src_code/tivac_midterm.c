...
#include "uartstdio.h" //had to include manually
#include "driverlib/interrupt.h"
#include "driverlib/hibernate.h"
#include "TSL2591_def.h"
#include "ustdlib.h" //had to include manually
...

{
    ...
    usprintf (HTTP_POST, "GET /update?key=VKJVWJLUNBFOK6CG&field1=%d&headers=falseHTTP/1.1\nHostapi.thingspeak.com\nConnection:close\Accept*\*\r\n\r\n", luxAvg);
